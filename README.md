...
After the system is installed and you boot into gnome, you can choose to install Discord, Steam, Wine, Lutris, Google Chrome, Spotify, qBitTorrent, GParted and some gnome extensions by running ./gui-programs.sh (Lutris will be configured for AMD)
