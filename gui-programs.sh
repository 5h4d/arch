...
makepkg -si
cd ..
sudo rm -r spotify gnome-shell-extension-ubuntu-dock idle-python3.7-assets gdm-plymouth
...
echo 'Save that and then open pavu, go to recording and choose "Monitor source of..........., Null Output. Go to Playback and in your desired app choose "Simultaneous Output to..........., Null Output" Open settings and try muting the sound sources until you do not hear yourself. Enjoy'
